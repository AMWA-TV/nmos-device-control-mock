...
export class NmosSenderVideoRaw extends NmosSender
{
        ...
        registrationClient: RegistrationClient)
    {
        ...
        this.active = new NmosSenderActiveRtp(
            ...
            [ new RtpSenderTransportParamsSetActive("239.100.20.0", "192.168.10.101", 10000, 10000), new RtpSenderTransportParamsSetActive("239.200.20.1", "192.168.20.101", 10000, 10000) ]);

        this.staged = new NmosSenderStagedRtp(
            null,
            true,
            new NmosActivation(null, null, null),
            [ new RtpSenderTransportParamsSetStaged("239.100.20.0", "192.168.10.101", 10000, 10000), new RtpSenderTransportParamsSetStaged("239.200.20.1", "192.168.20.101", 10000, 10000) ]);
...
m=video ${myTransportParamsLeg_0.destination_port} RTP/AVP 96
