...
import { NmosActivation } from './NmosReceiverCore';

export class NmosSenderVideo extends NmosSender
{
    public constructor(
        id: string,
        flow_id: string,
...
a=mid:secondary`;
    ...
    public ChangeSenderSettings(settings: NmosSenderActiveRtp)
    {
